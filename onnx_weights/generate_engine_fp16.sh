...
--fp16 --noTF32 \
--memPoolSize=workspace:4096 --dumpProfile  --separateProfileRun \
--exportLayerInfo="${export_layer_info_folder_path}/exportLayerInfo_fp16.txt" --exportProfile="${export_layer_info_folder_path}/exportProfile_fp16.txt"
